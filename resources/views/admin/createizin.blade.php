                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-6 col-12">
                        <div class="mb-1">
                            ...
                            <select class="form-select js-example-basic-single" id="jenis_izin" name="jenis_izin">
                                <option value="" selected disabled>-- Pilih Jenis Izin--</option>
                                @foreach ($jenisizin as $k)
                                    <option value="{{ $k->id_izin }}" data-lama_izin="{{ $k->lama_izin }}">
                                        {{ $k->jenis_izin }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-xl-4 col-md-6 col-12">
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control" id="lama_izin" name="lama_izin" readonly
                                value="" />
                        </div>
                    </div>
                </div>
                        ...
                        <div class="mb-1">
                            <div class="form-check form-check-success">
                                <input type="checkbox" class="form-check-input" id="validasi" name="validasi"
                                    value="1">
                                <label class="form-check-label" for="colorCheck3" required>Pengajuan izin dilakukan oleh
