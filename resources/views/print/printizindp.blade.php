    ...
    <div class="isi">
        ...
        <table class="table2">
            ...
            <tr>
                ...
                <td style="width:100px;text-align: center">:</td>
                <td style="font-size: 16px;"> {{ $data->singkatan_unit }} </td>
            </tr>
        </table>
    </div>

    <div class="isi">
        <p style="font-size: 16px;align:left;"> Dengan ini menyatakan bahwa saya hadir di itenas dan ditugaskan untuk
            <b> {{ $data->alasan }} </b>pada tanggal
            <b><?php echo \Carbon\Carbon::parse($data->tanggal_izin)->format('Y-m-d'); ?> </b> jam <b><?php echo \Carbon\Carbon::parse($data->tanggal_izin)->format('H:i:s'); ?></b>
