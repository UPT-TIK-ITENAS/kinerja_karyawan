...
@section('scripts')
            ...
            <div class="modal-content">
                ...
                <form autocomplete="off" class="needs-validation" novalidate=""
                    ...
                    <div class="modal-footer justify-content-between">
                        <button class="btn btn-primary" type="submit" id="btnSubmit">Approve</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        daterangepicker('#tanggal', drops = "auto", autoUpdate = false, autoApply = false, timePicker = false,
            parentEl = '#tambahIzin');
        ...
        $('#table-izin').on('click', '.edit-izin', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#id_mangkir").val(data.id_mangkir);
                },
                error: function(data) {
                    console.log(data);
                }
