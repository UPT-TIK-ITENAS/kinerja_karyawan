    ...
    <section>
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-xl-7"><img class="bg-img-cover bg-center" src="{{ asset('assets/images/login/Frame92.png') }}" alt="looginpage"></div>
            ...
            <div class="login-card">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group"><span class="input-group-text"><i
                        ...
                        <input class="form-control" type="text" name="nopeg" id="nopeg" required=""
                            placeholder="">
                    </div>
                </div>
                <div class="form-group">
